...
.ui_actions_menu, .page_actions_wrap, .page_actions_header, .ms_items_more, .tt_default, .tt_default_right, .im-page_classic .im-page--chat-header, .im-page_classic.im-page .im-page--chat-input, .im-page_classic.im-page .im-page--chat-body-wrap-inner, .im-page_classic.im-page .im-page--header, .emoji_tt_wrap, .selector_focused table.selector_table, .wdd_list, .online:after, #top_profile_menu, .replies_side, div.fc_tab_txt, div.fc_clist_filter_wrap, .privacy_dropdown .header, .privacy_dropdown, .idd_popup {border-color: %very_gray%;}
...
.fc_msgs, .fc_msgs_out .fc_msgs, .group_tokens_row:last-child {border: none!important;}
